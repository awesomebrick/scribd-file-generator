...
# ## i don't want someone accidentally deleting the stuff in the folder this script is in. it's still in here if someone wants it, though.
...
if not os.path.exists(folder_path):
    ...
    # if args.clean: ##commented out for the reasons above.
...
for i in range(file_count):
    ...
    # this has to store the entire string in memory. for relatively small string counts this is probably fine,
